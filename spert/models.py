...
from transformers import BertConfig, RobertaConfig,LongformerConfig,ElectraConfig
from transformers import BertModel, RobertaModel, LongformerModel,ElectraModel
from transformers import BertPreTrainedModel, RobertaPreTrainedModel,LongformerPreTrainedModel,ElectraPreTrainedModel
...
def get_token(h: torch.tensor, x: torch.tensor, token: int):
    ...
    token_h = h.contiguous().view(-1, emb_size)
...
class SpROB(RobertaPreTrainedModel):
    """ Span-based model to jointly extract entities and relations """
...
class SpELEC(ElectraPreTrainedModel):
    """ Span-based model to jointly extract entities and relations """
...
class SpLONG(LongformerPreTrainedModel):
    """ Span-based model to jointly extract entities and relations """
